...
@register_datamodule('equiaac_antigen')
class EquiAACAntigenDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == 'fit' or stage is None:
            self.train_dataset = EquiAACAntigenDataset(os.path.join(self.hparams.data_dir, "train.json"))
